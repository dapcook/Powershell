#<add 
# key                                    ="/patient-visitor/visitor-information/neighborhood-amenities" 
# value="https://www.kansashealthsystem.com/patient-visitor/hospital-amenities/neighborhood-guide" />

#https://www.kansashealthsystem.com/care/specialties/heart-care/innovations/clinical-trials
#https://www.kansashealthsystem.com/care/specialties/heart-care/resources
#https://www.kansashealthsystem.com/care/specialties/heart-care/resources/your-first-visit
#https://www.kansashealthsystem.com/care/centers/sports-medicine-performance-center


$Uri = "https://www.royalstreatment.com"
Get-UrlRedirections -Url $Uri


function Get-UrlRedirections{
    [CmdletBinding()]
    Param(
        [Parameter(Mandatory, ValueFromPipeline)] [Uri] $Url,
        [Switch] $Enumerate,
        [int] $MaxRedirections = 50    # Use same as default as [System.Net.HttpWebRequest]
        )
